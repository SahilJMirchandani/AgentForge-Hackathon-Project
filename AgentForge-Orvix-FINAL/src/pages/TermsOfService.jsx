    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-ink-soft">
          ...
          <section><h2 className="text-lg font-semibold text-ink">4. Connected services</h2><p className="mt-2">If you connect Google Gmail or another external service, you authorize AgentForge to use the permissions you grant for the workflows and features you configure. You can revoke or disconnect a connected service through the applicable provider or AgentForge settings.</p></section>
